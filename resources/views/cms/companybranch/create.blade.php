        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Create company branch</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form >
             ...
             <div class="row">
              ...
              <div class="card-footer">
                ...
                <a href="{{ route('companybranchs.index') }}" type="submit" class="btn btn-secondary">Go To Index</a>
...
<script>
   function performStore(){
    ...
    store('/cms/admin/companybranchs' , formData);
